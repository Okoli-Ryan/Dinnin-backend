...
namespace OrderUpAPI.Migrations
{
    ...
    [Migration("20240407213126_positive_permission_ids")]
    partial class positivepermissionids
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OrderUp_API.Models.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1508837528,
                            Alias = "Can Update user permissions",
                            Category = "PERMISSIONS",
                            Name = "PERMISSIONS__UPDATE_PERMISSIONS"
                        },
                        new
                        {
                            ID = 424904238,
                            Alias = "Can View user permissions",
                            Category = "PERMISSIONS",
